...
casa dw 0
CODESEG
proc ImprimePixel;Recebe a Casa decimal pela cor em ordem do Stack
...
proc ImprimeLinha;obtém índice de linha e cor
    pop[EnderecoDeRetorno2]
    pop cor
    mov cx,319
    printapixel:
    pop bx;tem coordenada y de linha
    push bx
    mov Memoria,cx
    push cor
    push bx
...
proc ImprimeCamadaDeLinha;obtém a coordenada y do início da linha e o final da linha
    pop[EnderecoDeRetorno2]
    pop cor
    pop cx
    printapixel2:
    ...
    push[EnderecoDeRetorno2]
    ret
endp ImprimeCamadaDeLinha

proc ImprimeColuna;gets index of collumn and cor
    pop[EnderecoDeRetorno2]
    pop cor
    mov cx,199
    printapixel3:
...
proc ImprimeLinhaEColuna;gets start of line x coordinate and end of line and cor
    pop[EnderecoDeRetorno2]
    pop cor
    pop cx
    printapixel4:
    ...
    push[EnderecoDeRetorno2]
    ret
endp ImprimeLinhaEColuna

proc Imprimeretangulo;gets starting position(bottom right corner), width and length and cor
    ...
    ret
endp Imprimeretangulo

proc ImprimeUm;prints one gets x and y coordinates and cor
...
proc ImprimeDois;prints two gets x and y coordinates and cor
    pop [EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
...
proc ImprimeTres;prints three to the screen gets x and y coordinates and cor
    pop [EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
...
proc ImprimeQuatro;prints four to the screen get x and y coordinates and a cor
    pop [EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
...
proc ImprimeCinco;prints five to the screen gets x and y coordinates and cor
    pop[EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
...
proc ImprimeSeis;prints six to the screen gets x and y coordinates and cor
    pop[EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
...
proc ImprimeSete;prints seven to the screen gets x and y coordinates and cor
    pop[EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
...
proc ImprimeOito;prints eight to the screen gets x and y coordinates and cor
    pop[EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
...
proc ImprimeNove;prints nine to the screen gets x and y coordinates and cor
    pop[EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
...
proc ImprimeSimboloAdicao;prints plus sign to the screen get x and y coordinates and cor
    pop[EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
    ...
    push[EnderecoDeRetorno4]
    ret
endp ImprimeSimboloAdicao

proc ImprimeSimboloSubtracao;prints minus sign to the screen get x and y coordinates and cor
    pop[EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
    ...
    push[EnderecoDeRetorno4]
    ret
endp ImprimeSimboloSubtracao

proc ImprimeSimboloMultiplicacao;prints multiplication sign to the screen gets x and y coortdinates and cor
    pop[EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
...
push dx
    ...
    push[EnderecoDeRetorno4]
    ret
endp ImprimeSimboloMultiplicacao

proc ImprimeSimboloDivisao;prints division sign to the screen gets x and y coordinates and cor
    pop[EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
    ...
    push[EnderecoDeRetorno4]
    ret
endp ImprimeSimboloDivisao

proc ImprimeSimboloIgual;prints the equals sign to the screen gets x and y coordinates and cor
    pop[EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
...
push cx
    ...
    push[EnderecoDeRetorno4]
    ret
endp ImprimeSimboloIgual

proc ImprimeZero;prints zero to the screen get x and y coordinates and cor
    pop[EnderecoDeRetorno4]
    pop cx
    pop dx
    pop cor
...
proc ImprimirCalculadora;prints the calculator
...
push 206 ;startx
    ...
    push 157 ;y coordinate
    push 206 ;x coordinate
    call ImprimeSimboloMultiplicacao
